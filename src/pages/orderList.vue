...
export default {
  ...
  methods: {
    ...
    changeOrderType (headItem) {                     
      this.tableHeads.map((item) => {                                        //所有项取消active属性 
        item.active = false
        return item
      })
      headItem.active = true                                                 //当前项增加active属性
      ...
      this.tableData = _.orderBy(this.tableData, headItem.key, this.currentOrder)              //升降序排列
    }
  },
  mounted () {
    this.getList()
